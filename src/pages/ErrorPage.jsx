    ...
    return (
        <div className="h-screen w-full flex justify-center items-center">
            <div className="max-w-[900px] mx-auto text-center">
                ...
                <Link to={"/"} className="btn relative px-10 py-3 font-medium text-white transition duration-300 bg-[#33A093] rounded-md hover:bg-[#33A093] ease">
                    ...
                    <span className="relative flex justify-center items-center"><IoChevronBackSharp  size={20}/>Home</span>
                </Link>
            </div>
        </div>
    );
