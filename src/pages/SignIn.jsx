...
const SignIn = () => {
    ...
    const handleLogin = async e => {
        ...
        e.preventDefault();
        if (emailErr || e.target.email.value === "" || e.target.password.value === "") {
        ...
        try {
            const { user: registerUser } = await emailPasswordSignIn(userData.email, userData.password);
            if (registerUser) {
                    ...
                    <form onSubmit={handleLogin} className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2 relative">
                                ...
                                <input type={passToggle ? "text" : "password"} name="password" id="password" placeholder="*****" className="w-full px-3 py-2 border-2 border-[#00df9a] rounded-md " />
