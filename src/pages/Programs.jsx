    ...
    return (
        <div className="min-h-[calc(100vh-435.6px)] max-w-[1600px] w-[95%] mx-auto my-8 md:my-2">
            ...
            <div className="flex flex-col md:flex-row-reverse justify-center items-center">
                <div data-aos="fade-up" data-aos-duration="1000" className="flex-1 space-y-4" >
                ...
                <div data-aos="fade-up" data-aos-duration="500" className="flex-1 flex justify-center">
            ...
            <div className="my-12 md:my-20">
                ...
                <div data-aos="fade-up" data-aos-duration="500" className="grid grid-cols-1 md:grid-cols-2 my-4 gap-6">
